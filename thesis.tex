...
% Remove Plan de Trabajo
% Explain better working methology
% Explain extension design process
% Mention git?
...
Con la realización de este proyecto se lograron alcanzar los objetivos definidos

Entre los resultados alcanzados con la culminación de este proyecto tenemos el diseño y conceptualización de una interfaz para describir el proceso de extracción de información de la web. En base a la experiencia y a la investigación de herramientas similares se concluyó que una extensión de navegador seria la implementación ideal para un programa con estos requerimientos, debido a la manera en que funcionan las extensiones fue necesario concebir un sistema de comunicación a través de mensajes entre la pagina web que se esté visitando y la extensión.

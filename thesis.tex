...
Selenium IDE es una herramienta de código abierto desarrollada por Selenium, la cual es una plataforma de automatización de pruebas de software de código abierto. Fue creada en 2006 por Jason Huggins, quien también creó Selenium Remote Control (Selenium RC).
